...
const SiteProgress = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center container mx-auto py-4 p-20 px-6 md:px-20 mt-12 lg:px-32 w-full overflow-hidden"
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80">
        Crafting spaces, Building Legacies - Explore Our Location Site Progress
      </p>
      <div className="flex flex-col md:flex-row items-center mx-auto md:w-full gap-8">
        ...
        <div className="md:w-1/2 w-full mb-8 md:mb-0">
          ...
          <p className="md:max-w-[440px]">
            In This section of our website you will be update as often as
            possible to get first hand information of the progress of the look
            of the site location and current development in the site. This will
        ...
        <div className="md:w-1/2 w-full ">
          <div className="relative">
            ...
            <button
              ...
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-orange-500 md:p-3 p-2 rounded-full shadow-lg cursor-pointer items-center"
            >
